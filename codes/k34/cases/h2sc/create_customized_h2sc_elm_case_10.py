...
#case index and date
iCase = 10
dMacropore_fraction = 0.25
sDate = '20240401'

aHillslope_width = [700*1445, 1035*671, 30*671, 3850*33, 1035*671,1035*671,1035*671,1035*671, 1.0]
aHillslope_length = [635, 978, 1367,5000, 978,978,978,978, 1]
aHillslope_slope = [0.08, 0.07,0.04,0.03, 0.07, 0.07, 0.07, 0.07, 0.01]
