...
for i in range(1, 11, 1):
    ...
    print(iCase_index,  np.mean(aData_out[month_index]))
...
sFilename_out = current_file_directory + slash + 'qdrain_tsplot_monthly.png'
iFlag_scientific_notation=1
iReverse_y=0

sLabel_y=r'Units: mm/s'
sTitle = r'Lateral groundwater flow'

dMin_y=0.0
dMax_y=1.2E-4

nData = len(aData)
nData_half = int(nData/2)
