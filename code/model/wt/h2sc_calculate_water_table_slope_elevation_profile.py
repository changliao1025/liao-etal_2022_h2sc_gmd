...
aDrop     = np.array([ 10.0, 20.0, 30.0, 40.0, 50.0])
aIncrease = np.array([ 10.0, 30.0, 70.0, 140.0, 250.0])
nCell = 1
...
for i in range(nCell):  
    ...
    dSlope_surface = 40.0/850.0 #from in situ measurement
    ...
    for j in range(nScenario):
        ...
        dDummy1 = np.power( dDummy1, dRatio3)
        dDummy2 = dRange_right_without_seepage * dDummy1
        D5 = D3 -  dDummy2
