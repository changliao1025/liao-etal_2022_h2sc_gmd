...
if iFlag_create_case ==1:
    ...
    if iFlag_lnd_atm_rof ==1:
        ...
        if iFlag_lnd ==1:
            ...
            sLine = "use_h2sc = .true." + '\n'
            ofs.write(sLine)
            sLine = "macropore_fraction = 0.25" + '\n'
            ofs.write(sLine)
            sLine = 'hist_empty_htapes = .true.' + '\n'
            ofs.write(sLine)
            sLine = "hist_fincl1 = 'QOVER', 'QDRAI', 'QRUNOFF', 'ZWT', 'QCHARGE','wt_slp','RAIN','SNOW','QSOIL', 'QVEGE','QVEGT', 'QDRAI_downslope','QDRAI_seepage','QDRAI_macropore' "  + '\n'
            ofs.write(sLine)

            sLine = "hist_fincl2 = 'QOVER', 'QDRAI', 'QRUNOFF', 'ZWT', 'wt_slp', 'QDRAI_downslope','QDRAI_seepage', 'QDRAI_macropore','gage_height' "  + '\n'
            ofs.write(sLine)
