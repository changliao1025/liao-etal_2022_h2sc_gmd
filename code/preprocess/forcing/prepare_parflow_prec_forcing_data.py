...
def replace_prec_forcing(oCase_in):
    sFolder_out  = '/compyfs/liao313/00raw/prec/parflow/prec'
    isExist = os.path.exists(sFolder_out)
    if not isExist:    
       # Create a new directory because it does not exist
       os.makedirs(sFolder_out)

    sVariable_forcing_in = 'prec'
        ...
        for iMonth in range(1, 12 + 1, 1):
            ...
            for sFilename in glob.glob(sRegex):
                ...
                for iStep in range(nts):
                    ...
                    print(dummy[row_index, column_index])
...
if __name__ == '__main__':
    ...
    replace_prec_forcing(oCase_y_in)